...
data housing;
  set housing_raw (RENAME= (element2=data_type_code element3=time_slot_id element4=error_data
...
libname homes '/mnt/viya-share/homes';
libname data '/mnt/viya-share';
...
/* Create a new folder under homes - carlos */

libname carlos '/mnt/viya-share/homes/carlos';
